...
public class TestEncapsulation {
    public static void main(String[] args) {
        ...
        EmployeeNew employee1 = new EmployeeNew("John Doe", 30, 5000.0);
        
        // Second employee using default constructor and setters
        System.out.println("\nCreating second employee using setters...");
        EmployeeNew employee2 = new EmployeeNew();
        ...
        try {
            EmployeeNew clonedEmployee = (EmployeeNew) employee1.clone();
    ...
    public static String compareSalaries(EmployeeNew emp1, EmployeeNew emp2) {
